...
public class OrganisationServiceAdaptor {
    ...
    @Autowired
    public OrganisationServiceAdaptor(OrganisationService organisationService, OrganisationConverter organisationConverter) {
    ...
    public OrganisationDto addAddress(UUID organisationUuid, AddressCreation address) throws ApplicationException {
        return organisationConverter.apply(organisationService.addAddress(organisationUuid, address));
    }
