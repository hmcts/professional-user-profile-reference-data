...
public class PaymentAccountControllerTest {
    ...
    @InjectMocks
    protected PaymentAccountController packagedBankAccountController;
    ...
    public void createPaymentAccountShouldCallCreateFormPaymentAccountService() throws Exception {
        ...
        mvc.perform(post("/pup/payment-accounts").with(user("user"))
    ...
    public void getPaymentAccountShouldReturnThePaymentAccount() throws Exception {
        ...
        mvc.perform(get("/pup/payment-accounts/1").with(user("user")))
            .andExpect(status().isOk())
    ...
    public void deletePaymentAccountShouldCallTheDeleteMethodFormProfessionalUserService() throws Exception {
        ...
        mvc.perform(delete("/pup/payment-accounts/1").with(user("user")))
